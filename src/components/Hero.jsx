...
const Hero = () => {
  ...
  return (
    <div className="relative bg-[#020617] text-white min-h-screen flex flex-col justify-center items-center px-6 md:px-10 overflow-hidden">
      ...
      <img src="/images/bitcoin.png" alt="Bitcoin" className="spinning-globe absolute top-[15%] md:top-[42%] left-[3%] w-16 md:w-28 opacity-80 transition-all duration-1000" />
      <img src="/images/globe.png" alt="Planet" className="absolute top-[8%] right-[2%] w-16 md:w-28 spinning-globe drop-shadow-[0_0_15px_rgba(34,197,94,0.4)]" />
      <img src="/images/coin-1.png" alt="Silver Coin" className="absolute bottom-[20%] right-[5%] w-12 md:w-20 opacity-70 spinning-globe transition-all duration-1000" />
      <img src="/images/rocket.png" alt="Rocket" className="absolute bottom-[2%] md:bottom-[2%] left-[-5%] md:left-[-3%] w-24 md:w-40 grayscale-[0.5] rotate-[-2deg] hidden md:block" />
      ...
      <div className="container max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center z-10 pt-20 md:pt-10">
        ...
        <div className="space-y-6 md:space-y-8 text-center lg:text-left">
          <h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.2] md:leading-[1.15]">
            Gateway to <span className="text-[#38bdf8]">Encrypt</span>,<br className="hidden md:block" />
            back up, and secure
            <br />
          ...
          <p className="text-base md:text-lg text-gray-400 max-w-[400px] mx-auto lg:mx-0 leading-relaxed">
            The easiest, safest, and fastest way to secure & back up crypto assets.
          </p>
        ...
        <div className="relative flex justify-center lg:justify-end items-center mt-10 lg:mt-0">
          ...
          <img src="/images/Web3.png" alt="Web evolution" className="relative z-10 w-full max-w-[350px] md:max-w-[550px] object-contain drop-shadow-2xl" />
        </div>
      </div>
...
{isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-black/60 backdrop-blur-md" onClick={closeModal}>
          <div 
            ...
            <div className="bg-[#111827]/50 border border-white/5 rounded-[24px] p-6 mb-2">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="relative w-12 h-12 flex items-center justify-center">
                  ...
                  <img src="/images/btcicon.png" alt="" className="w-12 h-12 z-10" />
                </div>
